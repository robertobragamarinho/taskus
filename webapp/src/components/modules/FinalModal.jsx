      ...
      <div className="relative bg-white rounded-2xl shadow-lg p-10 max-w-sm w-full">
        ...
        <Maintexts>
          ...
          <Paragraphs variant="black">
            Nossa equipe analisou seu perfil e <span className="font-hendrix-bold text-gray-900">você foi selecionado(a)</span>  para a vaga de Atendente de Suporte ao Cliente da TaskUs. <br/>
          </Paragraphs>
        </Maintexts>
