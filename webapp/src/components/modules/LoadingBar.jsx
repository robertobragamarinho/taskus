// modules/LoadingBar.jsx - Layout Horizontal (Círculo + Informações)
...
const LoadingBar = ({
  ...
  useEffect(() => {
    ...
    const loop = () => {
      ...
      // Atualiza tempo restante (sempre do relógio base, sem aleatoriedade)
      ...
      if (!isPaused && diff > 0) {
        ...
        // Quanto maior o diff, maior o passo base; multiplicamos por jitter e catch-up
      ...
      if (target >= 100 && nextDisplay < 100) {
        // Acelera para finalizar sem “teleportar”
  ...
  }, [linearProgress, totalDurationMs, randomize, speedMin, speedMax, jitterEveryMinMs, jitterEveryMaxMs, holdChance, catchupStart, catchupMaxBoost]);
