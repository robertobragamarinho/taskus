          ...
          <div className="p-5 overflow-y-auto grow" style={{ maxHeight: 'calc(85vh - 64px - 72px)' }}>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <Imputs
                ...
                readOnly
                onChange={() => {}}
                className="pointer-events-none bg-gray-100 break-all"
              />
                ...
                <div className="bg-white rounded-2xl border border-gray-200 p-6">
                  ...
                  <div className="mb-2">
                    ...
                    <p className="font-hendrix-regular text-gray-700 text-sm" style={{ fontSize: '11pt' }}>
                      Plano de saude, plano odontologico, férias remuneradas, plano de carreira e treinamentos de capacitação.
                    </p>
                  </div>
                </div>
              </div>
