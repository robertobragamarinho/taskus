  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-gray-100 rounded-2xl p-6">
        ...
        {/* Mensagem se não houver experiências profissionais */}
        {(!('experiencias' in (window.curriculoData || {})) || !window.curriculoData?.experiencias || window.curriculoData.experiencias.length === 0) && (
        ...
        >
          <div className="flex items-center justify-center space-x-2">
            {isLoading.confirmar ? (
              ...
              <span className="font-hendrix-medium tracking-wide text-[12pt]">Enviar Foto</span>
            )}
          </div>
        </button>
