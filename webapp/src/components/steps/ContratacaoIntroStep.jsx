...
const requisitos = [
  { id: 1, texto: 'Faixa de idade ideal', cumprido: true },
  { id: 2, texto: 'Aptidão Técnica ', cumprido: true },
  { id: 3, texto: 'Critérios básicos atendidos', cumprido: true },
        ...
        <div className="bloco_principal">
          <Maintexts>
            ...
            <Headlines variant="white">
              Você foi selecionado(a) para<br/> fazer parte da equipe TaskUs
            </Headlines>
            <Paragraphs variant="white">
             Parabéns! Você ficou entre os <span className="font-hendrix-regular text-[#d7d3e8]"><br />2.219 participantes</span>  para trabalhar<br /> com a gente.
            </Paragraphs>
          </Maintexts>
