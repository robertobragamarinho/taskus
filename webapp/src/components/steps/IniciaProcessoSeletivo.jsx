...
import { IconAlert, IconChatLike, IconMailEditLike } from "../modules/SvgIcons";
    ...
    <div className="bloco_principal">
      ...
      <Maintexts>
        ...
        <Paragraphs variant="black">
           Em menos de 2 minutos vamos<br/> te mostrar, de forma simples, os <br/>principais detalhes da vaga e como <br/>o trabalho funciona na prática.
        </Paragraphs>
      </Maintexts>
