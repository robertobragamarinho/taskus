          ...
          <div className="bloco_principal">
            ...
            <Maintexts>
              ...
              <Headlines variant="black">
                Agora você vai fazer<br/> um teste rápido que<br/>  simula situações reais<br/>  de atendimento
              </Headlines>

              <Paragraphs variant="black">
                É simples: escolha as respostas<br/>  que achar mais adequadas para<br/>  cada caso.
              </Paragraphs>
            </Maintexts>

            <CardTime
              text="O teste leva menos de 3 minutos."
              icon={InfoIconMin}
            />
          </div>
