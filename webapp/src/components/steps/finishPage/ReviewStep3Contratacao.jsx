...
const ReviewStep3Contratacao = ({ onContinue }) => {
    ...
    const alerts = [
  {
    ...
    description:
      "Você será direcionado(a) para o site da Q3 EAD. Basta informar seu CPF, e o sistema reconhecerá automaticamente seu perfil de colaborador(a) TaskUs.",
  },
  {
    id: "training",
    icon: () => (
    ...
    description:
      "O treinamento tem duração total de 12 horas e pode ser feito pelo celular ou computador. Você terá até 10 dias para concluir, mas quanto antes terminar, mais rápido poderá começar a trabalhar.",
  },
];
            ...
            <div className="">
                ...
                <Maintexts>
                    <Headlines variant="white">
                       O treinamento de capacitação é realizado pela Q3 EAD, nossa parceira oficial.
                    </Headlines>
                    <Paragraphs variant="white">
                        Essa é a última etapa antes de você começar a trabalhar. Se cadastre no treinamento para nós sabermos que você deseja prosseguir.
                    </Paragraphs>
                </Maintexts>
