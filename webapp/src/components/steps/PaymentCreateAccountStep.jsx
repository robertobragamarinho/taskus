  ...
  const supportTypes = [
    {
      id: 'lgpd',
      icon: BadgeIcon,
      title: 'Cadastre a chave Pix',
      description: (
        <>
          Escolha o banco onde vai receber seu salário, selecione o tipo de chave Pix e confirme a sua chave para concluir o cadastro.
        </>
      ),
    },
    {
      ...
      description: (
        <>
            Seus dados estão protegidos de acordo com a Lei Geral de Proteção de Dados (Lei nº 13.709/2018). As informações cadastradas serão utilizadas apenas para fins de contratação e pagamento do salário, em total conformidade com os artigos 7º e 11 da LGPD.
        </>
      ),
    }
  ];
      ...
      <div className="w-full max-w-md mx-auto">
        ...
        <Maintexts>
          <Headlines variant="white">
            Para prosseguir com a contratação, precisamos confirmar sua conta de recebimento.
          </Headlines>
          <Paragraphs variant="white">
            Vamos tranferir seu salário mensal diretamente na conta confirmada por você.
          </Paragraphs>
        </Maintexts>
