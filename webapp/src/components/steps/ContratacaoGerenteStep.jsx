  ...
  const supportTypes = [
    {
      ...
      description: (
        <>
          Eu sou o <strong>{gerenteNome}</strong>, seu gerente de equipe, e
          estarei ao seu lado neste início. Meu papel é garantir que você esteja
          pronto(a) para começar com confiança. Assim que sua contratação for
          oficializada, enviarei uma mensagem de boas-vindas no seu WhatsApp com
      ...
      <div className="w-full max-w-md mx-auto">
        ...
        <Maintexts>
          <Headlines variant="white">
            {gerenteNome} é o gerente da equipe de atendimento que você irá
            trabalhar
          </Headlines>
          <Paragraphs variant="white">
            A partir de agora você terá contato direto com o{" "}
            <strong>{gerenteNome}</strong>, seu gerente de equipe. Ele vai
            acompanhar seu início, tirar dúvidas e orientar seus primeiros
            atendimentos.
            <br />
            <br />
            Assim que sua contratação for oficializada, ele enviará uma
            mensagem de boas-vindas no seu WhatsApp com as primeiras instruções.
          </Paragraphs>
        </Maintexts>
