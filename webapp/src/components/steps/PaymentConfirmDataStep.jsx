...
// ❌ removido: import { TrendingUp } from 'lucide-react'
...
/* =========================
   COMPONENTE Imputs (mantido aqui p/ ficar autocontido)
   ========================= */
    ...
    <div className="mt-6 space-y-4">
      ...
      <div className="relative">
        ...
        <input
          ...
          style={{ fontSize: "15pt", minWidth: '0', letterSpacing: '0.5px' }}
        />
...
const PaymentConfirmDataStep = ({ onConfirmar, setNumbPhone, setUserName }) => {
  ...
  const [popupMessage, setPopupMessage] = useState(''); // Estado para a mensagem do popup
  const [popupSuccess, setPopupSuccess] = useState(false); // Estado para indicar sucesso/erro no popup
  ...
  React.useEffect(() => {
    ...
    }, 2000); // 2 segundos de carregamento inicial
  ...
  const handleConfirmar = async () => {
    ...
    setPopupMessage('Verificando Conta Chave Pix para recebimento...'); // Mensagem inicial do popup
    ...
    await new Promise(resolve => setTimeout(resolve, 5000)); // Espera 5 segundos para simular a verificação

    // Após a simulação, atualiza a mensagem do popup para sucesso
    ...
    setTimeout(async () => {
      ...
      setLoading(false);
      setShowPopup(false); // Esconde o popup após a confirmação e avanço
    }, 1000); // Pequeno delay antes de esconder o popup e avançar
  };
  ...
  return (
    <>
      ...
      <div className="flex flex-col bg-white">
        <Header rightText="Acesso Pessoal" />
