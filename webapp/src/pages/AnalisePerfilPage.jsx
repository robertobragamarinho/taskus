  ...
  const alerts = [
    {
      ...
      description:
        'cada resposta é registrada automaticamente, então leia com calma antes de continuar.'
    }
  ];

  // PERGUNTAS — versão formal
  const profileQuestions = [
    { id: 1,  question: "Você ja trabalhou com atendimento ao cliente?", subtitle: "A experiência prévia não é obrigatória para esta vaga.", answers: [{ id: 1, text: "Sim" }, { id: 2, text: "Não" }] },
    { id: 2,  question: "Você está pronto(a) para aproveitar essa oportunidade e crescer com a gente?", answers: [{ id: 1, text: "Sim, desejo muito esta oportunidade." }, { id: 2, text: "Tenho dúvidas no momento." }] },
    ...
    { id: 5,  question: "Você gosta de trabalhar em equipe?", answers: [{ id: 1, text: "Sim, gosto muito." }, { id: 2, text: "Consigo me adaptar conforme a necessidade." }, { id: 3, text: "Prefiro trabalhar individualmente." }] },
    { id: 6,  question: "Quando algo dá errado no trabalho, o que você faz?", answers: [{ id: 1, text: "Busco a solução de forma autônoma." }, { id: 2, text: "Solicito apoio a colegas ou superiores." }, { id: 3, text: "Fico apreensivo(a), mas tento resolver." }] },
    { id: 7,  question: "Você sonha em crescer e alcançar novos patamares na sua carreira?", answers: [{ id: 1, text: "Sim, esse é meu objetivo." }, { id: 2, text: "Talvez, depende da oportunidade." }, { id: 3, text: "Prefiro manter funções mais simples." }] },
    { id: 8,  question: "Como você aprende mais fácil: vendo, ouvindo ou praticando?", answers: [{ id: 1, text: "Assistindo a vídeos/aulas." }, { id: 2, text: "Lendo materiais escritos." }, { id: 3, text: "Praticando de forma autônoma." }, { id: 4, text: "Com orientação de colegas ou supervisores." }] },
    { id: 9,  question: "Você tem interesse em crescer, participar de treinamentos e eventos presenciais da TaskUs?", answers: [{ id: 1, text: " Sim, com certeza" }, { id: 2, text: "Sim, dependendo da carga de trabalho" }, { id: 3, text: "No momento, não tenho interesse" }] },
    ...
    { id: 13, question: "Você está disposto(a) a se dedicar para mudar de vida com essa oportunidade de trabalho?", answers: [{ id: 1, text: "Sim, estou 100% comprometido(a)." }, { id: 2, text: "Ainda possuo dúvidas, porém desejo tentar." }] },
    { id: 14, question: "Caso você seja contratado(a), se compromete a concluir o treinamento obrigatório antes de começar a trabalhar?", answers: [{ id: 1, text: "Sim, estou preparado(a) para realizar a capacitação." }, { id: 2, text: "Ainda não posso me comprometer." }] },
  ];
                ...
                > 
                  <div className="bloco_principal">
                    <Icons Icon={IconMessage} size={60} color="#1655ff" />
                     <section id='ETP2T2'/>
                    <Maintexts>
                      <Headlines variant="black">Agora queremos te<br/> conhecer um pouquinho<br/> melhor</Headlines>
                      <Paragraphs variant="black">
                        São 14 perguntas rápidas<br/> para entender seu perfil. Fique tranquilo(a), não tem resposta<br/> certa ou errada.
                      </Paragraphs>
                    </Maintexts>
